...
const page = (context:any) => {
    ...
    const form = useForm<z.infer<typeof messageSchema>>({
     ...
     const  initialMessageString= "What's your favorite movie?||Do you have any pets?||What's your dream job?";
      ...
      const {complete,completion,error,isLoading:isSuggestLoading} =useCompletion({api:'/api/suggest-messages',initialCompletion:initialMessageString})
